...
/**
 * fc comment，同质化nameresolver Resolves a possibility unresolved
 * {@link SocketAddress}.
 */
@UnstableApi
public interface AddressResolver<T extends SocketAddress> extends Closeable {
  ...
  /**
   * Returns {@code true} if and only if the specified address is supported by
   * this resolved.
   */
   ...
   *
   * @throws UnsupportedAddressTypeException if the specified address is not
   ...
   * @param address the address to resolve
   *
   * @return the list of the {@link SocketAddress}es as the result of the
   *         resolution
   */
